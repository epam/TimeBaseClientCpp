...
OBJ_LIB=data_reader data_writer loader_manager session_handler symbol_translator tickstream_cache tickdb\
 ...
 list_entities_request lock_stream_request periodicity_request schema_request timerange_request list_spaces_request rename_space_request delete_spaces_request bg_proc_info_impl\
